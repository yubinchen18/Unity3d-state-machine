	...
	
{
	public class PlayStateScene1_2 : IStateBase
	{
		...
		public PlayStateScene1_2 (StateManager managerRef)  //Constructor
		{
			manager = managerRef;
		...
		public void ShowIt()
		{
			...
			if (GUI.Button (new Rect(Screen.width/2 - 130, 10, 260, 30), string.Format ("Click here or Press 1 for Level 1, State 1"))
